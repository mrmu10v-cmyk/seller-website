...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    if (!form.email || !form.password) { setLocalError('Please enter both email and password'); return }
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-gray-900 to-gray-950 border-r border-gray-800 flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-gray-400 text-lg leading-relaxed max-w-sm">
            Thousands of quality products. Fast delivery. Best prices guaranteed.
          </p>
          <div className="flex gap-8 justify-center mt-12">
            {[{ n: '50K+', l: 'Products' }, { n: '10K+', l: 'Customers' }, { n: '4.9★', l: 'Rating' }].map(s => (
              <div key={s.l} className="text-center">
                <p className="text-2xl font-heading font-bold text-white">{s.n}</p>
